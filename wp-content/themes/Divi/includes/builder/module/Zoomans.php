...
class ET_Builder_Module_Zoomans extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Zoomans', 'et_builder' );
		$this->slug       = 'et_pb_zoomans';
		$this->vb_support = 'on';
...
//		$show_thumbnail      = $this->props['show_thumbnail'];
		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
				...
				$bootstrap_col = ' col-lg-3 col-md-6 col-sm-6 col-6';
                    ...
                    <div class="blog_item">
                        ...
                        <div class="blog_item-overlay">
                            ...
                            <div class="content_bottom">
                                ...
                                <p><span><?php echo esc_html( get_the_date( $meta_date ) ) ?></span></p>
                            </div>
                        </div>
                    </div>
                </a>
