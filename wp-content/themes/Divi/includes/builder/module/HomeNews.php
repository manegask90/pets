...
class ET_Builder_Module_HomeNews extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'HomeNews', 'et_builder' );
		$this->slug       = 'et_pb_home_news';
		$this->vb_support = 'on';
	...
	static function get_blog_posts( $args = array(), $conditional_tags = array(), $current_page = array() ) {
		...
		if ( $query->have_posts() ) {
			...
			while( $query->have_posts() ) {
				...
				// Print output
				?>
					<div id="" <?php post_class( 'et_pb_post clearfix' . $no_thumb_class . $overlay_class ) ?>>
						<?php
                    ...
                    <div class="blog_item">
                        ...
                        <div class="content">
                            <div class="content_wrapper">
                                ...
                                <<?php echo $processed_header_level; ?> class="news_tittle"><a href="<?php esc_url( the_permalink() ); ?>" class="blog_news_link"><?php the_title(); ?></a></<?php echo $processed_header_level; ?>>
                            </div>
                        </div>
                    </div>
                </div>
...
new ET_Builder_Module_HomeNews;
