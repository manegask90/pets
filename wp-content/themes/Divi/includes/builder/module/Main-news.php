...
class ET_Builder_Module_Main_news extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Main news', 'et_builder' );
		$this->slug       = 'et_pb_main_news';
		$this->vb_support = 'on';
        $this->fullwidth        = true;
               ...
               <?php //start-post ?>
                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class( 'et_pb_post clearfix' . $no_thumb_class . $overlay_class . $bootstrap_col  ); ?>>
                        <div class="main_news_item">
                            <div class="col-lg-4 col-md-12 img-wrap">
                                <div class="img_box">
                                    <a href="<?php esc_url( the_permalink() ); ?>">
                                        <?php print_thumbnail( $thumb, $thumbnail["use_timthumb"], $titletext, $width, $height ); ?>
                                    </a>
...
new ET_Builder_Module_Main_news;
