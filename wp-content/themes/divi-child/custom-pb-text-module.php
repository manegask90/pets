...
function ex_divi_child_theme_setup()
{
    ...
    if (class_exists('ET_Builder_Module')) {
        ...
        class ET_Builder_Custom_Text extends ET_Builder_Module
        {
            function init()
            {
        ...
        $et_pb_custom_text = new ET_Builder_Custom_Text();
        add_shortcode('et_pb_custom_text', array($et_pb_custom_text, '_shortcode_callback'));
